...
# Get from theme, like that what state in head
ZSH_THEME_GIT_PROMPT_PREFIX="$ZSH_THEME_DELIMITER%{$reset_color%}%{$fg[green]%}"
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_DIRTY="%{$fg[yellow]%}⚡%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_CLEAN=""

ZSH_THEME_RVM_PROMPT_OPTIONS="i v g"
ZSH_THEME_RVM_PROMPT_PREFIX="$ZSH_THEME_DELIMITER%{$fg[magenta]%}"
